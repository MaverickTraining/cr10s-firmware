...
#define CUSTOM_MACHINE_NAME "MSC CR-10S"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 3 // Change to 4 (16 points) or 5 (25 points) to get a more accurated reading, but takes more time.
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X

  // Set the boundaries for probing (where the probe can reach).
  #define LEFT_PROBE_BED_POSITION 20
  #define RIGHT_PROBE_BED_POSITION 261
...
#define LCD_BED_LEVELING
  ...
  #define MBL_Z_STEP 0.07    // Step size while manually probing Z axis.
